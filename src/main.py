...
REQUIRED_DIRS = [
    RAW_DATA_PATH,
    PROCESSED_SEGMENT_QRS,
    PROCESSED_SEGMENT_NOTQRS,
    WAVELET_IMG_QRS,
    WAVELET_IMG_NOTQRS,
    PROCESSED_DATA_PATH,
    os.path.dirname(CSV_LOG_FILE),
    SAVED_MODEL_DIR,
    'images/testDataset/QRS',
    'images/testDataset/notQRS',
]
...
def convert_segments_to_wavelet_imgs():
